...
export const homeConstants = {
  ...
  fetch_homeData_fail: "fetch_homeData_request_failure",
};
...
export const memberRegister = {
  ...
  register_member_fail: "register_member_request_failure",
  selected_membership: "selected_membership_request",
};
...
export const newsConstants = {
  ...
  fetch_news_fail: "fetch_news_request_failure",
  //filtering news
  filter_news: "filter_news_request",
  filter_news_success: "filter_news_request_success",
  filter_news_fail: "filter_news_request_fail",
};
...
export const knowledgeConstants = {
  ...
  fetch_knowledge_fail: "fetch_knowledge_request_failure",
};
